...
def main(instanc_size=511, num_threads=24):
    ...
    sub_sets = (
        "ILSVRC2013_train",
        "ILSVRC2013_train_extra0",
        "ILSVRC2013_train_extra1",
        "ILSVRC2013_train_extra2",
        "ILSVRC2013_train_extra3",
        "ILSVRC2013_train_extra4",
        "ILSVRC2013_train_extra5",
        "ILSVRC2013_train_extra6",
        "ILSVRC2013_train_extra7",
        "ILSVRC2013_train_extra8",
        "ILSVRC2013_train_extra9",
        "ILSVRC2013_train_extra10",
    ...
    for sub_set in sub_sets:
        ...
        with futures.ProcessPoolExecutor(max_workers=num_threads) as executor:
            fs = [
                executor.submit(crop_xml, xml, sub_set_crop_path, instanc_size)
                for xml in xmls
            ]
